...
CANDIDATES: list[dict[str, Any]] = [
    ...
    {
        "name": "i3l9r5_d512e192_q16q8t_coret_lqer_lidx_r6t12",
        "base_profile": "i1l2r2_d512_e128_h8kv1_mlpinner_mlp075",
        "preset": "2060sprint_micro_muon_cooltaper5k_cold_tokens8k",
        "env": {
            **route_env(
    ...
    {
        "name": "i4l9r5_d512e192_q16q8q4t_coret_lqer_lidx_r6t12",
        "base_profile": "i1l2r2_d512_e128_h8kv1_mlpinner_mlp075",
        "preset": "2060sprint_micro_muon_cooltaper5k_cold_tokens8k",
        "env": {
            **route_env(
    ...
    {
        "name": "i5l9r9_d512e192_q16q8q4q2t_coret_lqer_lidx_r6t12",
        "base_profile": "i1l2r2_d512_e128_h8kv1_mlpinner_mlp075",
        "preset": "2060sprint_micro_muon_cooltaper5k_cold_tokens8k",
        "env": {
            **route_env(
